...
public class MainRead extends AppCompatActivity implements
    ...
    private com.example.tgsprak7.CustomListAdapter adapter_off;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter_off = new com.example.tgsprak7.CustomListAdapter(this, listGame
        );
        ...
        listGame.clear();
        List<Game> game = db.ReadMahasiswa();
        for (Game mhs : game) {
            Game daftar = new Game();
    ...
    public void onItemClick(AdapterView<?> parent, View view, int i, long l) {
        ...
        Game detailMhs = (Game)o;
        String Sid = detailMhs.get_id();
        String Snama = detailMhs.get_nama();
        String Skelas = detailMhs.get_kelas();
        Intent goUpdel = new Intent(MainRead.this,com.example.tgsprak7.MainUpdel.class);
